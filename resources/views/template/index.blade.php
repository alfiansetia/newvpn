        ...
        function edit(show = false) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#edit_html_up').val(result.data.html_up);
                    $('#edit_html_vc').val(result.data.html_vc);
                    $('#detail_html_up').html(result.data.html_up);
                    $('#detail_html_vc').html(result.data.html_vc);
                    if (show) {
                        show_card_detail()
                        input_focus('name')
                    }
