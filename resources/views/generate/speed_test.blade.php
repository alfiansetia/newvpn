@extends('layouts.backend.template', ['title' => 'Speed Test'])
...
@push('css')
    ...
    <link href="{{ cdn('backend/src/assets/css/light/pages/contact_us.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ cdn('backend/src/assets/css/dark/pages/contact_us.css') }}" rel="stylesheet" type="text/css" />
@endpush
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row" id="div_form">
                        ...
                        {{-- <div class="form-group col-md-12 mb-2">
                            <label class="control-label" for="interface">Interface Name :</label>
                            <input type="text" name="interface" class="form-control" id="interface"
                                placeholder="Please Enter Interface Name" minlength="2" maxlength="50" required>
                        ...
                        <div class="form-group col-md-12 mb-2">
                            ...
                            <input type="text" name="gateway" class="form-control" id="gateway"
                                placeholder="192.168.168.1" minlength="2" maxlength="50" value="192.168.168.1" autofocus
                                required>
