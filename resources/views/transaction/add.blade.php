<div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing" id="card_add" style="display: none;">
    <div class="widget-content widget-content-area br-8">
        ...
        <form id="form" class="was-validated" action="{{ route('api.transactions.store') }}" method="POST">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label class="control-label" for="date"><i class="far fa-calendar me-1 bs-tooltip"
