                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label class="control-label" for="edit_acc_name"><i
                                        class="fas fa-file-signature me-1 bs-tooltip" title="Acc Name"></i>Acc Name
                                    :</label>
                                ...
                                <span id="err_edit_acc_name" class="error invalid-feedback"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label class="control-label" for="edit_acc_number"><i
                                        class="fas fa-file-invoice-dollar me-1 bs-tooltip" title="Acc Name"></i>Acc
                                    Number
                                    :</label>
                                <input type="text" name="acc_number" class="form-control maxlength"
                                    id="edit_acc_number" placeholder="Please Enter Acc Name" minlength="1"
                                    maxlength="100" required>
                                <span id="err_edit_acc_number" class="error invalid-feedback"
                                    style="display: hide;"></span>
                            </div>
                        </div>
                        <div class="form-group mb-2">
