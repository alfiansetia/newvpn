...
@push('js')
    <script>
        const url_index = "{{ route('mikapi.system.group') }}" + param_router
        const url_index_api = "{{ route('api.mikapi.system.groups.index') }}"
        const url_index_api_router = "{{ route('api.mikapi.system.groups.index') }}" + param_router
        var id = 0
        var perpage = 50
    </script>
