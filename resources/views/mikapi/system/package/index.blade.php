@extends('layouts.backend.template_mikapi', ['title' => 'Package'])
@push('csslib')
    <!-- DATATABLE -->
...
@push('js')
    <script>
        const url_index = "{{ route('mikapi.system.package') }}" + param_router
        const url_index_api = "{{ route('api.mikapi.system.packages.index') }}"
        const url_index_api_router = "{{ route('api.mikapi.system.packages.index') }}" + param_router
        var id = 0
        var perpage = 50
    </script>
