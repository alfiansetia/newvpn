@extends('layouts.backend.template_mikapi', ['title' => 'Script'])
@push('csslib')
    <!-- DATATABLE -->
...
@push('js')
    <script>
        const url_index = "{{ route('mikapi.system.script') }}" + param_router
        const url_index_api = "{{ route('api.mikapi.system.scripts.index') }}"
        const url_index_api_router = "{{ route('api.mikapi.system.scripts.index') }}" + param_router
        var id = 0
        var perpage = 50
    </script>
            ...
            columns: [{
                ...
                render: function(data, type, row, meta) {
                    if (type == 'display') {
                        ...
                        if (row.invalid) {
                            text +=
                                '<span class="badge me-1 badge-danger bs-tooltip" title="Invalid">X</span>'
                        }
                        text += `</div>`
                        return text
                    } else {
