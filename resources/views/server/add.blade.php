<div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing" id="card_add" style="display: none;">
    <div class="widget-content widget-content-area br-8">
        ...
        <form id="form" class="was-validated" action="{{ route('api.servers.store') }}" method="POST">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="form-group col-md-6 mb-2">
                            ...
                            <span class="error invalid-feedback err_domain" style="display: hide;"></span>
                        </div>
                        <div class="form-group col-md-6 mb-2">
                            ...
                            <span class="error invalid-feedback err_netwatch" style="display: hide;"></span>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="form-group col-md-6 mb-2">
                        ...
                        <div class="form-group col-md-6 mb-2">
                            ...
                            <span class="error invalid-feedback err_sufiks" style="display: hide;"></span>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="form-group col-md-6 mb-2">
                    ...
                    <div class="row mb-2">
                        <div class="form-group col-md-6 mb-2">
                            ...
                            <input type="text" name="port" class="form-control mask_angka" id="port"
                                placeholder="Please Enter Port" value="0" min="0" required>
                            <span class="error invalid-feedback err_port" style="display: hide;"></span>
                        </div>
                        <div class="form-group col-md-6 mb-2">
                            ...
                            <span class="error invalid-feedback err_last_ip" style="display: hide;"></span>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="form-group col-md-6 mb-2">
                        ...
                        <div class="form-group col-md-6 mb-2">
                            ...
                            <input type="text" name="annual_price" class="form-control mask_angka"
                                id="annual_price" placeholder="Please Enter Annual Price" value="0"
                                min="0" required>
                            <span class="error invalid-feedback err_annual_price" style="display: hide;"></span>
                        </div>
                    </div>
                    <div class="row mb-2">
