        ...
        <div class="account-content">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <form id="form_info" class="section general-info"
                        action="{{ route('setting.company.telegram.update') }}" method="POST">
                        @csrf
                        <div class="info">
    ...
    <script>
        $(document).ready(function() {
            ...
            function set(action) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('setting.company.telegram.set') }}",
                    data: {
                        '_method': 'PUT',
                        'action': action,
                    },
            ...
            $('#form_info').submit(function(event) {
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('setting.company.telegram.update') }}",
                        data: $(form).serialize(),
                        beforeSend: function() {
                            block();
                        },
