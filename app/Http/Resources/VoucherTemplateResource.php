...
class VoucherTemplateResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'html_vc_sample'    => $html_vc_sample,
            'html_up_sample'    => $html_up_sample,
        ];
    }
}
